...
class InfiniteCourt:
    ...
    def update(self):
        ...
        # quadrant 2
        self.q2l = (int(common.boy.x) - self.cw // 2) % self.w
        self.q2b = 0
        self.q2w = clamp(0, self.w - self.q2l, self.cw)
        self.q2h = self.ch - self.q3h
        # quadrand 4
        self.q4l = 0
        self.q4b = (int(common.boy.y) - self.ch // 2) % self.h
        self.q4w = self.cw - self.q3w
        self.q4h = clamp(0, self.h - self.q4b, self.ch)
        # quadrand 1
        self.q1l = 0
        self.q1b = 0
        self.q1w = self.cw - self.q3w
        self.q1h = self.ch - self.q3h
